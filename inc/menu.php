<header id="header">
	...
	<div class="search">
		...
		{ // Usuario conectado.
			...
			echo '<a href="desconectar.html"><img src="img/doc_export_icon&16.png" alt="Desconectar"/></a>';
		}
		?>
	</div>
	<!-- end of search -->
		...
		switch ($_SESSION['tipousuario'])
		{
			case 'a':
				...
				<ul>
					...
					<li <?php if ($paginaActiva == 'crearticket') echo $opcionActivada; ?>><a href="crearticket.html">Abrir incidencia</a></li>
					...
					<li <?php if ($paginaActiva == 'respuestas') echo $opcionActivada; ?>><a href="respuestas.html">Respuestas</a></li>
					<li <?php if ($paginaActiva == 'topicos') echo $opcionActivada; ?>><a href="topicos.html">Tópicos</a></li>
					<li <?php if ($paginaActiva == 'prioridades') echo $opcionActivada; ?>><a href="prioridades.html">Prioridades</a></li>
					...
					<li <?php if ($paginaActiva == 'imprimir') echo $opcionActivada; ?>><a href="imprimir.html">Imprimir</a></li>
					<li <?php if ($paginaActiva == 'perfil') echo $opcionActivada; ?>><a href="perfil.html">Perfil</a></li>
				</ul>
				<?php
				break;
